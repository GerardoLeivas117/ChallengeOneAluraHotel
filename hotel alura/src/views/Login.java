...
public class Login extends JFrame {
	...
	private void Login() {
		...
		String usuario = txtUsuario.getText(); // Obtener el usuario ingresado
		String contrasena = new String(txtContrasena.getPassword()); // Obtener la contraseña ingresada

		// Buscar el usuario en la base de datos
		Usuarios usuarioEncontrado = userControl.buscarUsuarioPorId(usuario);

		if (usuarioEncontrado != null && usuarioEncontrado.getPassword().equals(contrasena)) {
			// Si el usuario y la contraseña coinciden, mostrar el menú y cerrar la ventana
			// actual
